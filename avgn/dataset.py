...
class DataSet(object):
    ...
    def __init__(
        self, DATASET_ID, hparams=None, default_rate=None, build_mel_matrix=True, sub_dir=None
    ):
        ...
        if sub_dir==None:       
            ...
            self.dataset_loc = (DATA_DIR / "processed" / DATASET_ID / sub_dir
            )
            if not os.path.exists(self.dataset_loc):
