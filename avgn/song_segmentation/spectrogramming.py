...
def preemphasis(x,hparams):
  preemphasis_val =   hparams.preemphasis
  return lfilter([1, -preemphasis_val], [1], x)
...
def _stft_parameters(hparams):
  n_fft = (hparams.n_fft - 1) * 2
  hop_length = int(hparams.hop_length_ms / 1000 * hparams.sample_rate)
